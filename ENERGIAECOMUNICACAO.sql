CREATE TABLE Antena_Comunic (
  ...
  INDEX Antena_Comunic_FKIndex1(Complexo_Comunicacao_Org_Pub_Civil, Complexo_Comunicacao)
);
...
CREATE TABLE Area_Energia_Eletrica (
  ...
  INDEX Area_Energia_Eletrica_FKIndex1(Complexo_Gerador_Energia_Eletrica, Complexo_Gerador_Energia_Eletrica_Org_Pub_Civil)
);
...
CREATE TABLE Complexo_Comunicacao (
  ...
  INDEX Complexo_Comunicacao_FKIndex2(Org_Pub_Civil)
);
...
CREATE TABLE Complexo_Gerador_Energia_Eletrica (
  ...
  INDEX Complexo_Gerador_Energia_Eletrica_FKIndex2(Est_Gerad_Energia_Eletrica, Est_Gerad_Energia_Eletrica_Ponto_Trecho_Energia),
  INDEX Complexo_Gerador_Energia_Eletrica_FKIndex3(Edif_Energia),
  INDEX Complexo_Gerador_Energia_Eletrica_FKIndex4(Subest_Transm_Distrib_Energia_Eletrica_Ponto_Trecho_Energia, Subest_Transm_Distrib_Energia_Eletrica)
);
...
CREATE TABLE Condutor_Hidrico (
  ...
  INDEX Condutor_Hidrico_FKIndex1(Massa_Dagua),
  INDEX Condutor_Hidrico_FKIndex2(Complexo_Gerador_Energia_Eletrica, Complexo_Gerador_Energia_Eletrica_Org_Pub_Civil),
  INDEX Condutor_Hidrico_FKIndex3(Termeletrica, Termeletrica_Est_Gerad_Energia_Eletrica, Termeletrica_Est_Gerad_Energia_Eletrica_Ponto_Trecho_Energia),
  INDEX Condutor_Hidrico_FKIndex4(Hidreletrica_Est_Gerad_Energia_Eletrica, Hidreletrica_Hidreletrica, Hidreletrica_Est_Gerad_Energia_Eletrica_Ponto_Trecho_Energia)
);
...
CREATE TABLE Edif_comunic (
  ...
  INDEX Edif_comunic_FKIndex1(Complexo_Comunicacao_Org_Pub_Civil, Complexo_Comunicacao)
);
...
CREATE TABLE Reservatorio_Hidrico (
  ...
  INDEX Reservatorio_Hidrico_FKIndex1(Complexo_Gerador_Energia_Eletrica, Complexo_Gerador_Energia_Eletrica_Org_Pub_Civil)
);
...
CREATE TABLE Subest_Transm_Distrib_Energia_Eletrica (
  ...
  INDEX Subest_Transm_Distrib_Energia_Eletrica_FKIndex1(Ponto_Trecho_Energia),
...
CREATE TABLE Torre_Comunic (
  ...
  INDEX Torre_Comunic_FKIndex2(Antena_Comunic),
  INDEX Torre_Comunic_FKIndex3(Complexo_Comunicacao_Org_Pub_Civil, Complexo_Comunicacao)
);
...
CREATE TABLE Torre_Energia (
  ...
  INDEX Torre_Energia_FKIndex1(Zona_Linhas_Energia_Comunicacao)
);
...
CREATE TABLE Trecho_Cominic (
  ...
  INDEX Trecho_Cominic_FKIndex1(Zona_Linhas_Energia_Comunicacao)
);
...
CREATE TABLE Trecho_Energia (
  ...
  INDEX Trecho_Energia_FKIndex1(Ponto_Trecho_Energia),
  INDEX Trecho_Energia_FKIndex2(Torre_Energia),
  INDEX Trecho_Energia_FKIndex3(Zona_Linhas_Energia_Comunicacao)
);
...
CREATE TABLE Zona_Linhas_Energia_Comunicacao (
  ...
  INDEX Zona_Linhas_Energia_Comunicacao_FKIndex1(Complexo_Gerador_Energia_Eletrica, Complexo_Gerador_Energia_Eletrica_Org_Pub_Civil),
  INDEX Zona_Linhas_Energia_Comunicacao_FKIndex2(Complexo_Comunicacao_Org_Pub_Civil, Complexo_Comunicacao)
);